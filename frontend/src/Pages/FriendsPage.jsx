          ...
          <div className="space-y-4">
            {friends?.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-gray-400">You don't have any friends yet. Start adding some!</p>
              </div>
            ) : (
                        ...
                        <div className="flex items-center gap-4">
                          <div className="relative">
                            <div className="w-16 h-16 rounded-full ring-4 ring-emerald-600/50 overflow-hidden bg-slate-700">
                              ...
                              />
                              <div className="w-full h-full bg-gradient-to-br from-emerald-600 to-teal-600 text-white flex items-center justify-center text-2xl font-bold hidden">
                                {friend.fullName ? friend.fullName[0].toUpperCase() : 'U'}
                              </div>
                            </div>
                          </div>
                          <div>
                            <h3 className="font-bold text-lg text-white">{friend.fullName || 'Unknown User'}</h3>
