    ...
    <div className="group bg-slate-800/30 border border-slate-700 rounded-2xl p-6 hover:border-emerald-500/50 hover:bg-slate-800/50 transition-all duration-300 hover:scale-105 backdrop-blur-sm w-full">
      ...
      <div className="space-y-3 mb-4">
        <div className="flex flex-col sm:flex-row gap-3">
          {nativeLanguage && (
            <div className="flex items-center gap-2 flex-1 bg-emerald-500/10 px-3 py-2 rounded-lg min-w-0">
          ...
          {learningLanguage && (
            <div className="flex items-center gap-2 flex-1 bg-slate-700/50 px-3 py-2 rounded-lg min-w-0">
